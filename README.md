...
This repo contains the Android client library & samples for Speech-to-Text in the Microsoft Bing Speech API, part of [Cognitive Services](https://www.microsoft.com/cognitive-services).
